...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/UUU10K")
...
CHANNEL_SUDO = getenv("CHANNEL_SUDO", "")
YAFA_NAME = getenv("YAFA_NAME", "")
YAFA_CHANNEL = getenv("YAFA_CHANNEL", "")
